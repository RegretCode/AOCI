...
# instruções possível.
	...
	sll $t2, $t1, 1		#desloca o t1 de 1 bit e salva em t2. t2 = 00000000000000000000000000000010 = 2
	or $t1, $t1, $t2 	#concatena o t1 e o t2 e salva em t1. t1 = 00000000000000000000000000000011 = 3
	
	sll $t2, $t1, 2		#desloca o t1 de 2 bits e salva em t2. t2 = 00000000000000000000000000001100 = 12
	or $t1, $t1, $t2	#concatena o t1 e o t2 e salva em t1. t1 = 00000000000000000000000000001111

	sll $t2, $t1, 4		#desloca o t1 de 4 bits e salva em t2. t2 = 00000000000000000000000011110000
	or $t1, $t1, $t2	#concatena o t1 e o t2 e salva em t1. t1 = 0000000000000000000000000011111111
	
	sll $t2, $t1, 8		#desloca o t1 de 8 bits e salva em t2. t2 = 0000000000000000001111111100000000
	or $t1, $t1, $t2	#concatena o t1 e o t2 e salva em t1. t1 = 0000000000000000001111111111111111
	
	sll $t2, $t1, 16	#desloca o t1 de 16 bits e salva em t2. t2 = 11111111111111110000000000000000
